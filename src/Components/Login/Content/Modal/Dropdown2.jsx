...
export default function Dropdown2({label, name, options=[], handleCountry, country, style }) {
    return (
        <div className='flex items-center my-2'>
        {label && <div className='min-w-[165px]'>{label}</div>}
        <Listbox as="div" className={`relative inline-block ${style|| 'w-[77%'} mt-[10px]`} onChange={handleCountry} >
            <div>
            ...
            >
                <Listbox.Options className="h-[18rem] overflow-auto absolute z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                        {

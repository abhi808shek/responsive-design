...
export default function Dropdown({label,up, style, name, options=[], handleChange , selectedValue, keyName}) {
    return (
        ...
        <Listbox as="div" className={`relative inline-block ${style}`} onChange={handleChange} >
            <div>
                <Listbox.Button  className={`inline-flex w-full gap-x-1.5 rounded-md bg-white px-3 py-2 text-xs ${selectedValue ? 'text-black-500' : 'text-gray-400'} shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50`}>

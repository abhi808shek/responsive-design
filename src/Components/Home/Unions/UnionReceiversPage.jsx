...
const UnionReceiversPage = ({ title }) => {
  return (
    <div className="w-[40%] bg-[#E4E7EC] mx-auto flex flex-col items-center gap-2 h-[88%] mt-1 pt-4 px-4">
      {/* {[1, 2, 3, 4, 5]?.map(() => (
      ...
      <div className="flex h-[40px] w-full">
        ...
        <div className=" flex flex-1 flex-col justify-center ml-2">
          <h1 className="text-[12px]">
            Invitations:
            <span className="font-bold text-blue-400 text-sm"> Abhi </span>
            invited you to join the union
          </h1>
          <span className="font-bold text-blue-400 text-sm">Jansena Party</span>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-5 w-full">
        ...
        <button
          // key={elem}
          className="w-[35%] bg-[#7991BD] text-white font-bold py-1 text-xs rounded-lg"
          // style={{
        ...
        <button className="text-[#666567] w-[35%] py-1 border-2 text-xs border-[#666567] rounded-lg">
          Cancel
        </button>
        {/* ))} */}
      </div>

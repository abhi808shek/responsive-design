...
const MyUnion = ({
  ...
  return (
    <>
              ...
              >
                ...
                {isValid ? (
                  <MenuDropdown
                    ...
                    handleOption={(optionName) => openModalOption(optionName, elem)}
                  />
                ) : (
                  <button
      ...
      {modalType?.editPost && (
        <Portals>
          <UnionUpdateModal handleInputChange={handleUpdateUnion} unionName={unionName} 
          handleCloseModal={closeModalOption} updateUnion={updateUnion} />
        </Portals>
      )}

      {modalType?.deletePost && (
        <Portals>
          <ExitUnionModal exitUnion={exitUnion} onCloseModal={closeModalOption} />
        </Portals>
      )}
    </>
  );

...
import kicksBeforeLikes from '../../../../../Assets/Images/Kicks before like.png';
    ...
    <div className="flex justify-around pt-1 items-center w-full">
      ...
      <div className="flex flex-col bg-[#D6DEEB] w-[80%] rounded-xl px-3 pt-1 gap-1 relative">
        ...
        <div className="flex gap-3 items-center">
          ...
          <span className="text-xs font-semibold">{comment.Replies.length} Repliess</span>
        </div>
      </div>
      <div className="flex flex-col gap-1">
        <img src={kicksBeforeLikes} alt="" className="w-[30px] cursor-pointer" />
        <img src="./images/replyIcon.png" alt="" className="w-[30px] h-[30px] cursor-pointer" />
      </div>
    </div>
  )
}

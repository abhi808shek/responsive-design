...
const AboutSection = ({ isOther, data }) => {
  ...
  const isPersonal = profiletype === "Personals";
  return (
      ...
      <section className="flex flex-col w-full my-4 gap-2">
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <p className="text-sm w-full">
            ...
            <strong>: {moment(data?.dob).format("YYYY")}</strong>
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <p className="text-sm w-full">
            ...
            <strong>: {personalname?.gender}</strong>
          </p>
        </div>
        ...
        {isPersonal ? (
          ...
          <p className="text-sm w-full">
            <strong className="text-md font-medium w-1/2 inline-block">Company</strong>
            <strong>: { ( job ) ? `works ${ company ? `at ${''}`: ""} ${ job ? `as ${job}`: ""}` : "" }</strong>
          </p>
        </div>
              ...
              <>
                ...
                <div className="flex items-center gap-2 px-4">
                  <p className="text-sm">
                    ...
                    {
                      ugpassyears ?
                        <>in the year <strong>{ugpassyears} -  </strong></>
                        : ""
                    }
                    <strong> <br />
                      {ugbranch}

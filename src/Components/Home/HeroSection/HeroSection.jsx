...
const onHandleClick = ()=>{
  ...
  return (
    <div  className=" w-[40%] h-[400px] flex justify-center bg-white flex-col items-center rounded-lg mt-[10px] " onClick={onHandleClick}> 
        ...
        <div className="w-full h-[75%] flex justify-center">
          <img src={image && image[0]} alt="" className="w-[90%] h-[100%] rounded-lg"/>
        </div>

      ...
      <section className="flex w-[42%] col-span-2 flex-col">
        <div className=" ">
          <div className="flex w-full items-center my-1">
            ...
            <input type='search' placeholder='search by video, profile, hastag...' className='w-full mx-2 h-10 rounded-lg outline-none px-2' onFocus={()=>setIsFocused(true)} width={95} bgColor="#fff" />
